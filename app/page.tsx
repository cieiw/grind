...
export default function Home() {
  ...
  function openVisibleInstagram() {
    overviewAccounts.forEach((account) => {
      if (account.instagramUrl.trim()) window.open(account.instagramUrl, "_blank", "noopener,noreferrer");
    });
  }
